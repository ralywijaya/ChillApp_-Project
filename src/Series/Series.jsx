...
export default function Series() {
  ...
  return (
    <main>
      <SectionHero />
      <SectionMelanjutkan
        subJudul={"Melanjutkan Tonton Film"}
        KategoryFilm={KategoryFilmMelanjutkan}
      />

      <SectionSeriesChill
        subJudul={"Persembahan Chill"}
        KategoryFilm={KategoryFilmPersembahan}
      />

      <SectionTopRating
        subJudul="Top Rating Film dan Series Hari ini"
        KategoryFilm={KategoryFilmTopRating}
      />
      <SectionFilmRilis subJudul="Rilis Baru" KategoryFilm={KategoryFilmRiis} />
      <SectionFilmTranding
        subJudul="Film Trending"
        Film={FilmPopuler}
        KategoryFilm={KategoryFilmTranding}
      />
    </main>
  );
}
