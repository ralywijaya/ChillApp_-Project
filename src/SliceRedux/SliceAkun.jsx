...
const AkunSlice=createSlice({
    ...
    export const {AmbilAkun,TambahAkun,HapusAkun,AmbilFotoProfil,AmbilDaftarSaya,LoadingDaftarSaya,ErrorDaftarSaya,AmbilDaftarVersion,AmbilDaftarSayaTMDB}=AkunSlice.actions
